package com.adminservice.keygenerator;
...
public class SignupSessionKeyGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        ...
        return String.format("SS"+timestamp.toString()+"%010d", nextValue);
    }
